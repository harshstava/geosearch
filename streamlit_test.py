...
if 'tissue_input' not in st.session_state:
    st.session_state.tissue_input = None
if 'technology_input' not in st.session_state:
    st.session_state.technology_input = None
...
st.session_state.tissue_input = st.sidebar.text_input("Keywords")
st.session_state.technology_input = st.sidebar.text_input("Platform Keywords")
...
if len(st.session_state.tissue_input) != 0 and len(st.session_state.technology_input) != 0 and st.session_state.initial_input == 1: 

    

    tissue_input = (st.session_state.tissue_input).split(",")


    technology_input = (st.session_state.technology_input).split(",")
